...
class Solution(object):
    def numUniqueEmails(self, emails):
        ...
        def transform(email):
            ...
            local = local.replace('.', '')
            return (local, domain)
        return len(set([transform(e) for e in emails]))

    def test(self):
        print self.numUniqueEmails(["a@leetcode.com","b@leetcode.com","c@leetcode.com"])
        print self.numUniqueEmails(["test.email+alex@leetcode.com",

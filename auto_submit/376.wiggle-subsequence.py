...
class Solution(object):
    def wiggleMaxLength(self, nums):
        ...
        cur = nums[0]
        for n in nums:
            if n > cur and (prev is None or prev > cur):
                maxlen += 1
                prev = cur
            elif n < cur and (prev is None or prev < cur):
                maxlen += 1
                prev = cur
            cur = n
        return maxlen
    ...
    def test(self):
        print self.wiggleMaxLength([1,7,4,9,2,5])
        print self.wiggleMaxLength([1,17,5,10,13,15,10,5,16,8])
        print self.wiggleMaxLength([1,2,3,4,5,6,7,8,9])
